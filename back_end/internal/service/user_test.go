...
func TestUserService_RegisterByPhone(t *testing.T) {
	...
	password := "pgtest123"
	err := userService.Register(context.Background(), db, phone, email, password)
	if err != nil {
...
func TestUserService_RegisterPhoneExists(t *testing.T) {
	...
	phone := "18888888888"
	cleanTestUser(t, db, userDAO, phone, "")
	_ = userService.Register(context.Background(), db, phone, "", "pgtest123")
	err := userService.Register(context.Background(), db, phone, "", "any")
...
func TestUserService_RegisterEmailExists(t *testing.T) {
	...
	email := "pgtest@example.com"
	cleanTestUser(t, db, userDAO, "", email)
	_ = userService.Register(context.Background(), db, "", email, "pgtest456")
	err := userService.Register(context.Background(), db, "", email, "any")
